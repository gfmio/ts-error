...
export const printConsoleStatement = () => {
  const objectSetPrototypeOfIsDefined =
    typeof Object.setPrototypeOf === "function";
  log(
    "Object.setPrototypeOf is " +
      (objectSetPrototypeOfIsDefined ? "" : "un") +
      "defined",
  );
  const objectGetPrototypeOfIsDefined =
    typeof Object.getPrototypeOf === "function";
  log(
    "Object.getPrototypeOf is " +
      (objectGetPrototypeOfIsDefined ? "" : "un") +
      "defined",
  );
  const objectDefinePropertyIsDefined =
    typeof Object.defineProperty === "function";
  log(
    "Object.defineProperty is " +
      (objectDefinePropertyIsDefined ? "" : "un") +
      "defined",
  );
  const objectCreateIsDefined = typeof Object.create === "function";
  log("Object.create is " + (objectCreateIsDefined ? "" : "un") + "defined");
  const objectHasOwnPropertyIsDefined =
    typeof Object.prototype.hasOwnProperty === "function";
  log(
    "Object.hasOwnProperty is " +
      (objectHasOwnPropertyIsDefined ? "" : "un") +
      "defined",
  );
  ...
  if (isBrowser) {
    if (hasConsole) {
      if (noConsole) {
        ...
        log(
          "Your browser support console, but you have passed the noConsole flag. The test results will be displayed below.",
        );
      } else {
        logToBrowser(
          "Open your JavaScript console / developer tools to see the test results",
        );
      }
    } else {
      log(
        "This browser does not have a console. The test results will be displayed below.",
      );
    }
  } else {
    log(
      "You should only run this code in a browser. The node.js tests are provided separately.",
    );
  }
};
